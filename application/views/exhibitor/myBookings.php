				...
				<?php foreach($positions as $pos):?>
					...
					>
						...
						<td>
							...
							<a href="<?php echo BASE_URL.'invoices/fairs/'.$pos['fair'].'/exhibitors/'.$pos['id'].'/'.str_replace('/', '-', $pos['invoicecompany']) . '-' . $pos['invoiceposname'] . '-' . $pos['invoiceid'] . '.pdf'?>" target="_blank" title="<?php echo $tr_viewinvoice; ?>">
