...
<div class="tbld tbl1">
	<div class="excelCheckboxes" data-for="booked" id="checkboxesBooked">
		...
		<input onclick="multiCheck(this, 'popupbooked')" type="checkbox" checked="checked" />
	</div>
			...
			<tbody>
				<?php foreach ($users as $user): ?>
					<tr>
						...
						<td class="excelCheckboxTd"><input type="checkbox" id="<?php echo $user->get('id'); ?>" checked="checked" /></td>
...
<div class="tbld tbl2">
	<div class="excelCheckboxes" data-for="connected" id="checkboxesConnected">
		...
		<input type="checkbox" value="4" checked="checked" />
		<input type="checkbox" value="5" checked="checked" />
		<input onclick="multiCheck(this, 'popupconnected')" type="checkbox" checked="checked" />
	</div>
	<!--<a onclick="prepareTable('connected', 'checkboxesConnected')"><button style="width: 97%;"><?php echo $export?></button></a>-->
	<a class="showExportPopup" data-table="connected"><button style="width: 97%;"><?php echo $export; ?></button></a>
	<div class="scrolltbl">
