...
<div class="tbld tbl1">
	<a onclick="prepareTable('booked')"><button style="float:right; margin-top:17px;"><?php echo $export?></button></a>
...
<div class="tbld tbl2">
<a onclick="prepareTable('connected')"><button style="float:right; margin-top:17px;"><?php echo $export?></button></a>
