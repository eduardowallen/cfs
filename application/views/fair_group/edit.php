...
$(document).ready(function() {
	...
	$('input[type="submit"]').click(function(e) {
		...
		var dataString = 'editGroup=' + encodeURIComponent($("#groupid").val())
...
<input type="hidden" id="groupid" name="groupid" value="<?php echo $group->get('id'); ?>"/>
<fieldset class="floatleft">
<label for="groupname"><?php echo $name_label; ?> *</label>
<input type="text" id="groupname" name="groupname" value="<?php echo $group->get('name'); ?>"/>
</fieldset>
<fieldset style="padding-left:2em; display:inline;">
<label for="invoice_no"><?php echo $invoice_no_label; ?> *</label>
<input type="number" min="1" id="invoice_no" name="invoice_no" value="<?php echo $group->get('invoice_no'); ?>"/>
</fieldset>
<br>
<br>
<br>
...
<table id="group_table" class="display table table-striped table-border" width="100%" cellspacing="0">
  ...
  <tbody>
<?php foreach ($group->get('fairs_rel') as $fair) { ?>
  	<tr>
  		<td><?php echo uh($fair['fair']); ?></td>
  		<td><?php echo uh($fair['name']); ?></td>
  		<td><?php echo uh(loadRealInvoiceId($fair['fair'])); ?></td>
  		<td><?php echo uh($fair['share_invoice']); ?></td>
  	</tr>
<?php } ?>
  </tbody>
</table>
