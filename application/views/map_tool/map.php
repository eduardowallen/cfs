...
<div id="map_div_info">
	...
	<label>
		<input type="button" class="greenbutton <?php if (userLevel() > 0): echo $_SESSION['user_fair']; else: echo $_SESSION['outside_fair_url']; endif; ?> mapdivbtn rulesLink" value="<?php echo uh($translator->{'Rules'}); ?>" />
	</label>
	<label>
		<input type="button" class="greenbutton <?php if (userLevel() > 0): echo $_SESSION['user_fair']; else: echo $_SESSION['outside_fair_url']; endif; ?> mapdivbtn contactLink" value="<?php echo uh($translator->{'Contact'}); ?>" />
	</label>
</div>
	<style>
	#maptool_grid {
...
<!-- multistep form -->
<form id="apply_mark_form" class="form booking_form popup">
<!-- progressbar -->
<ul id="progressbar">
