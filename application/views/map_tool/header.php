...
>>>>>>> 980f404875926bfcc97d750f6b936ab3a0b2c217
	...
	lang.alias_error = '<?php echo ujs($translator->{"The username can only exist of lowercase symbols a-z, 0-9 and underscores"}); ?>';
...
<div id="alertBox2">
		<p><?php echo uh($translator->{'This fair is hidden and you are not allowed to administer this event. Therefore, you will be redirected to your profile.'}); ?></p>
		<p class="dialog-buttons">
			<input type="button" id="confirm_ok" value="<?php echo uh($translator->{'OK'}); ?>"/>
</div>
	<div id="wrapper">
