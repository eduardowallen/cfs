...
<<<<<<< HEAD
	...
	var sms_send_popup = $('<form id="sms_send_popup" class="dialogue" style="width: 400px; position:fixed;"><img src="images/icons/close_dialogue.png" alt="" class="closeDialogue close-popup" />'
		+ '<h2><img src="images/icons/smsicon.png" alt="" class="icon_sms_popup" />' + lang.sms_popup_title + '</h2>'
		+ '<p><strong>' + lang.sms_enter_message + '</strong><textarea name="sms_text"></textarea></p>'
...
>>>>>>> 980f404875926bfcc97d750f6b936ab3a0b2c217
	...
	$('.loginlink').click(function(e) {
		...
		var html = '<form action="' + url + '" method="post" id="popupform_login" class="dialogue2" style="display:inline-block;">'
				 ...
				 +		'<img src="images/button_icons/Chartbooker Fair System Logotype.png" alt="" class="nouser_cfslogo" style="margin-left:5px;" />'
				 +		'<p class="logo_text">' + lang.logo_text + '</p>'
				 +		'<div><p class="error"></p>'
				 + 		'<label for="user" style="font-size: 16px;">' + lang.login_username + '</label>'
				 + 		'<input type="text" class="login_textfield" name="user" id="user" size="20"/>'
				 + 		'<label for="pass" style="font-size: 16px;">' + lang.login_password + '</label>'
				 ...
				 + 		'<p><input type="submit" value="' + lang.sign_in + '" name="login" class="save-btn"/></p></div>'
				 +		'</div>'
				 + 	'</form>';
	...
	$('.registerlink').click(function(e) {
		...
		editor_selector : "presentation",
	        ...
	        plugins : "style,table,advimage,advlink,inlinepopups,insertdatetime,preview,paste,fullscreen,noneditable,visualchars,xhtmlxtras",
					theme_advanced_buttons1 : "undo,redo,|,bold,italic,underline,strikethrough,|,bullist,numlist,|,link,unlink,|,justifyleft,justifycenter,justifyright,justifyfull,|,cut,copy,paste,code",
